...
class Init_COWriteID_Request_type
{
public:
  explicit Init_COWriteID_Request_type(::canopen_interfaces::srv::COWriteID_Request & msg)
  : msg_(msg)
  {}
  ::canopen_interfaces::srv::COWriteID_Request type(::canopen_interfaces::srv::COWriteID_Request::_type_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_COWriteID_Request_type data(::canopen_interfaces::srv::COWriteID_Request::_data_type arg)
  {
    msg_.data = std::move(arg);
    return Init_COWriteID_Request_type(msg_);
  }
