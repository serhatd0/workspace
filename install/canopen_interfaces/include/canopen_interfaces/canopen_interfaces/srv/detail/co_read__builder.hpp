...
class Init_CORead_Request_type
{
public:
  explicit Init_CORead_Request_type(::canopen_interfaces::srv::CORead_Request & msg)
  : msg_(msg)
  {}
  ::canopen_interfaces::srv::CORead_Request type(::canopen_interfaces::srv::CORead_Request::_type_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_CORead_Request_type subindex(::canopen_interfaces::srv::CORead_Request::_subindex_type arg)
  {
    msg_.subindex = std::move(arg);
    return Init_CORead_Request_type(msg_);
  }
