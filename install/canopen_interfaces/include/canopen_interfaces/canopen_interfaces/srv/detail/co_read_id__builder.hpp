...
class Init_COReadID_Request_type
{
public:
  explicit Init_COReadID_Request_type(::canopen_interfaces::srv::COReadID_Request & msg)
  : msg_(msg)
  {}
  ::canopen_interfaces::srv::COReadID_Request type(::canopen_interfaces::srv::COReadID_Request::_type_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_COReadID_Request_type subindex(::canopen_interfaces::srv::COReadID_Request::_subindex_type arg)
  {
    msg_.subindex = std::move(arg);
    return Init_COReadID_Request_type(msg_);
  }
