...
static const ::rosidl_typesupport_introspection_cpp::MessageMember COData_message_member_array[4] = {
  {
    "index",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(canopen_interfaces::msg::COData, type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
