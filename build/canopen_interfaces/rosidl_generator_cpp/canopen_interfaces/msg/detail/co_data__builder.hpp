...
class Init_COData_type
{
public:
  explicit Init_COData_type(::canopen_interfaces::msg::COData & msg)
  : msg_(msg)
  {}
  ::canopen_interfaces::msg::COData type(::canopen_interfaces::msg::COData::_type_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_COData_type data(::canopen_interfaces::msg::COData::_data_type arg)
  {
    msg_.data = std::move(arg);
    return Init_COData_type(msg_);
  }
