...
class Init_COWrite_Request_type
{
public:
  explicit Init_COWrite_Request_type(::canopen_interfaces::srv::COWrite_Request & msg)
  : msg_(msg)
  {}
  ::canopen_interfaces::srv::COWrite_Request type(::canopen_interfaces::srv::COWrite_Request::_type_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_COWrite_Request_type data(::canopen_interfaces::srv::COWrite_Request::_data_type arg)
  {
    msg_.data = std::move(arg);
    return Init_COWrite_Request_type(msg_);
  }
